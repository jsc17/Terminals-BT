...
<main>
  <div class="validation-body">
    ...
    >
      ...
      <div class="section">
        <h2>
          2. Select an era, faction, and ruleset to check list validity. If you have chosen a tournament, some of these options may already be set and locked
        </h2>
        <label>
          Rules:
    ...
    <div class={{ section: true, "locked-section": unitData.length == 0 }}>
      <h2 class="tournament-select-header">
        3. Review Unit Data (You shouldn't have to do anything here unless it misread any of the units from the uploaded pdf)
      </h2>
    ...
    >
      ...
      {/if}
      <label
        ><input type="checkbox" name="permission" bind:checked={submitApproval} required disabled={issues == undefined || issues?.issueList.size > 0} /> By submitting
        this list, you acknowledge your email address and name will be provided to the tournament organizer. Any personal data stored Terminal.tools will be removed
        after the tournament has completed.</label
      >
