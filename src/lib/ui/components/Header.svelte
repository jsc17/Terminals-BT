<script lang="ts">
	...
	import { toastController, appWindow } from "$lib/global/stores";
	import { LoginModal, NotificationPopover } from ".";
	import { type ActionResult } from "@sveltejs/kit";
	import { goto } from "$app/navigation";
	import { page } from "$app/state";
	import { enhance } from "$app/forms";
	import type { List } from "$lib/types";
	import type { Notification } from "$lib/ui/types/notification";
