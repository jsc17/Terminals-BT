<script lang="ts">
	...
	import { CritBoxAero, CritBoxCv, CritBoxMech, CritBoxProto } from "$lib/components/playmode";
	import { DamageModal, HeatModal, CritModal, ExpandModal, SpecialModal } from "$lib/components/playmode";
