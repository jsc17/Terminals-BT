<script lang="ts">
	...
	import { TournamentCreationSchema } from "./schema.js";
...
<main>
	{#if data.username}
		...
		<section class="card">
			...
			<form
				{...createTournament.preflight(TournamentCreationSchema).enhance(async ({ submit }) => {
					await submit();
			...
			>
				...
				<p>
					Tournament Teams:
					<span class="description">Will allow players to enter a team name when submitting their list. This will be optional, so people without partners can still submit.</span>
				</p>
